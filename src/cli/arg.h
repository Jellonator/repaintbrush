...
namespace cli {
    ...
    public:
        ...
        /// found, or an option which expects an argument do not have an
    ...
    struct ArgParse {
        ...
        bool m_hasarg; /// Whether or not this option expects an argument to follow it
        boost::optional<char> m_short; /// Shortened name of the option
    };
